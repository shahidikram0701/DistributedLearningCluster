...
var file_coordinator_sdfs_proto_proto_rawDesc = []byte{
	...
	0x61, 0x74, 0x61, 0x4e, 0x6f, 0x64, 0x65, 0x73, 0x32, 0xd6, 0x02, 0x0a, 0x19, 0x43, 0x6f, 0x6f,
...
var file_coordinator_sdfs_proto_proto_goTypes = []interface{}{
	...
	(*CoordinatorListAllNodesForFileRequest)(nil), // 4: process.CoordinatorListAllNodesForFileRequest
	(*CoordinatorListAllNodesForFileReply)(nil),   // 5: process.CoordinatorListAllNodesForFileReply
}
var file_coordinator_sdfs_proto_proto_depIdxs = []int32{
	...
	4, // 2: process.CoordinatorServiceForSDFS.ListAllNodesForFile:input_type -> process.CoordinatorListAllNodesForFileRequest
	1, // 3: process.CoordinatorServiceForSDFS.PutFile:output_type -> process.CoordinatorPutFileReply
	3, // 4: process.CoordinatorServiceForSDFS.UpdateFileVersion:output_type -> process.CoordinatorUpdateFileVersionReply
	5, // 5: process.CoordinatorServiceForSDFS.ListAllNodesForFile:output_type -> process.CoordinatorListAllNodesForFileReply
